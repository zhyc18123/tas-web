...
function getLodop(oOBJECT,oEMBED){
  ...
  var strHtmUpdate="<br><font color='#FF00FF'>打印控件已安装,可以打印。</font>";
  var strHtm64_Install="<br><font color='#FF00FF'>打印控件未安装!点击这里<a href='./install_lodop64.exe' target='_self'>执行安装</a>,安装后请刷新页面或重新进入。</font>";
  var strHtm64_Update="<br><font color='#FF00FF'>打印控件已安装,可以打印。</font>";
  ...
  var strCLodopUpdate="<br><font color='#FF00FF'>打印控件已安装,可以打印。</font>";
  var LODOP;
  try{
