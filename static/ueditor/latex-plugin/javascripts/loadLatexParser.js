(function(){
  ...
  LatexParser.prototype.handleSave = function(){
    ...
    dialog.onok = function(){
      ...
      function parseNext(){
        var text = latexEditor.display.view[parseIndex].line.text.trim()
        editor.execCommand('inserthtml', '<img class="latex" src="http://trp.yuyou100.com/equation?preview=true&tex='+ encodeURIComponent(text) +
          '" data-latex="' + text + '" />');
  ...
  LatexParser.prototype.getImg = function ( latex ) {
    ...
    if( latex ) {
      this.count ++
      $("<img src=\"http://trp.yuyou100.com/equation?preview=true&tex=" + encodeURIComponent(latex) +
