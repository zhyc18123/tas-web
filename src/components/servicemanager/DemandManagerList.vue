      ...
      <div class="widget am-cf">
        ...
        <div class="am-u-sm-12">
          <el-table :data="tableData" border stripe style="min-width: 100%">
            ...
            <el-table-column label="需求分类" min-width="100">
            ...
            <!--</el-table-column>-->
            <el-table-column label="期待完成时间" min-width="100">
              <template scope="scope">{{scope.row.forwardFinishTime | formatDate}}</template>
            </el-table-column>
                ...
                <el-dropdown>
                  ...
                  <el-dropdown-menu slot="dropdown">
                   <!-- <el-dropdown-item v-if="hasPermission('edit')"
                    ...
                    <el-dropdown-item v-if="hasPermission('off')" @click.native="offDemand(scope.row.productId)">下架</el-dropdown-item>
                    <el-dropdown-item v-if="hasPermission('del')" @click.native="deleteDemand(scope.row.productId)">删除</el-dropdown-item>
                  </el-dropdown-menu>
                </el-dropdown>
              </template>
            </el-table-column>
  ...
  export default{
    ...
    methods: {
      ...
      loadTableData: function (pageNo) {
        ...
        io.post(io.apiAdminDemandList, $.extend({
          pageNo: _this.pageNo,
