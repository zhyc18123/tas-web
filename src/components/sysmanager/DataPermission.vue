  ...
  <div class="am-u-sm-12 am-u-md-12 am-u-lg-12">
    <div class="widget am-cf">
      <div class="widget-head am-cf">
        <div class="widget-title am-fl">设置数据权限</div>
...
<script>
  ...
  export default{
    ...
    mounted: function () {
      var _this = this
      _this.loadSysDataPermissionConfig()
    },
    ...
    methods: {
      ...
      save: function () {
        ...
        var _this = this
        io.post(io.apiAdminSaveUserDataPermission, {
      ...
      loadSysDataPermissionConfig: function () {
        var _this = this
        io.post(io.apiAdminSysDataPermissionConfig, {},
          function (ret) {
            if (ret.success) {
      ...
      loadPermission: function () {
        var _this = this
        io.post(io.apiAdminUserDataPermissionList, {
            userId: _this.$params('userId')
          },
          function (ret) {
            if (ret.success) {
