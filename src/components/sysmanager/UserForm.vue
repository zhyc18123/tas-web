          ...
          <fieldset>
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9 input-field">
                <input type="text"  class="am-form-field" placeholder="输入用户名" required v-model="formData.username">
              </div>
            </div>
            <div class="am-form-group">
              <label class="am-u-sm-3 am-form-label">
              ...
              <div class="am-u-sm-9 input-field">
                <input type="text"  class="am-form-field" placeholder="输入姓名" required v-model="formData.realName">
              </div>
            </div>
