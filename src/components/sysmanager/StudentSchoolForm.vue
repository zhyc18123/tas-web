  ...
  <div class="am-u-sm-12 am-u-md-12 am-u-lg-12" >
    <div class="widget am-cf">
      <div class="widget-head am-cf">
        <div class="widget-title am-fl">生源学校信息</div>
...
import conf from '../../lib/conf'
    ...
    export default{
        ...
        created:function(){
         var studentSchoolId  = this.$params('studentSchoolId')
         if(studentSchoolId){
          var _this = this
          io.post(io.apiAdminStudentSchoolDetail,{ studentSchoolId : studentSchoolId },
            function(ret){
              if(ret.success){
        ...
        methods:{
          save:function(complete){
            var _this = this
            io.post(io.apiAdminSaveOrUpdateStudentSchool,_this.formData,
            function(ret){
              complete.call()
              if(ret.success){
                _this.$toast('OK')
                _this.$router.push('/main/sys/student/school/list')
              }else{
