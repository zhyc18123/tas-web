      ...
      <el-table :data="tableData" style="width: 100%">
        ...
        <el-table-column align="center" label="操作">
          <template scope="scope">
            ...
            <el-button v-show="scope.row.isEdit" class="btn-delete" @click="scope.row.isEdit = false;tagList()">取消</el-button>
          </template>
        </el-table-column>
      </el-table>
    </div>
...
export default {
  ...
  methods: {
    ...
    tagList() {
      io.post(io.tagList, { subjectName: '' }, (data) => {
