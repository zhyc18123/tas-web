        ...
        <form class="am-form tpl-form-border-form tpl-form-border-br" data-am-validator :id="id">
          <fieldset>
            ...
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9 input-field">
                <input type="text" class="am-form-field" placeholder="输入手机号" data-validation-message="输入正确的手机号码" pattern="^1((3|4|5|7|8){1}\d{1}|70)\d{8}$" required v-model="formData.phoneNo"/>
              </div>
            </div>
