<template>
  <div class="am-u-sm-12">
    ...
    <el-table
      ...
      <el-table-column
        ...
        <template scope="scope">
          ...
          <el-button size="small" :disabled="scope.row.regFrom == 1 || scope.row.chargingStatus == 2 ||  scope.row.chargingStatus == 4" @click.native="cancel(scope.row.courseOrderId)">撤销</el-button>
    ...
    <window ref="cert" title="听课证">
      ...
      <div style="height:68px;" id="certIframe">
