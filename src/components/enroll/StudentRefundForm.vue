      ...
      <div class="am-u-sm-12 am-scrollable-horizontal">
        ...
        <table width="100%" class="am-table am-table-bordered am-table-compact am-text-nowrap">
          ...
          <tr>
            ...
            <td>
              <input type="number"  class="am-input-sm" :readonly="formData.refundLectureFrom == availableRefundLectures[0].lectureNo"  v-model="formData.finalRefundAmount" min="0" @change="checkFinalRefundAmount">
            </td>
            <td colspan="6">
            </td>
          </tr>
