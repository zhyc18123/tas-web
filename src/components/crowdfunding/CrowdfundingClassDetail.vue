        ...
        <fieldset>
          <div class="am-form-group">
            ...
            <div class="am-u-sm-9 input-field">
              <input type="number" placeholder="" min="0" step="0.01"  required  v-model="formData.deposit" >
            </div>
          </div>
          <div class="am-form-group">
            <label class="am-u-sm-3 am-form-label">
          ...
          <div  class="am-form-group" v-for="(item, index) in priceList" v-if="formData.discountType == 2">
            ...
            <div class="am-u-sm-2 input-field">
              <input type="number" min="0" step="1" class="am-form-field" required placeholder="" v-model="priceList[index].number" >
            </div>
            <label class="am-u-sm-2 am-form-label">
              <span class="am-text-danger am-margin-right-xs am-text-xs">*</span>价格/人
        </label>
            <div class="am-u-sm-2 input-field">
              <input type="number" min="0" step="0.01" class="am-form-field" required placeholder="" v-model="priceList[index].price" >
            </div>
          ...
          <div id ="div2" v-if="formData.discountType == 1">
            <div class="am-form-group">
              ...
              <div class="am-u-sm-9 input-field">
                <input type="number" min="0" step="1" placeholder=""  required  v-model="formData.quotaMin" >
              </div>
            </div>
            <div class="am-form-group">
              <label class="am-u-sm-3 am-form-label">
              ...
              <div class="am-u-sm-9 input-field">
                <input type="number" placeholder=""  required  v-model="formData.quotaMax" >
              </div>
            </div>
            <div class="am-form-group">
              <label class="am-u-sm-3 am-form-label">
              ...
              <div class="am-u-sm-9 input-field">
                <input type="number" min="0" step="0.01" placeholder=""  required  v-model="formData.totalPrice" >
              </div>
            </div>
          </div>
