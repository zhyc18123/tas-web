<template>
  <div class="lecture">
    <el-form :inline="true" :model="form" class="t-form gray">
      ...
      <el-form-item label="">
        <el-select v-model="form.region" placeholder="讲次类型">
          <el-option label="区域一" value="shanghai"></el-option>
          <el-option label="区域二" value="beijing"></el-option>
        </el-select>
      </el-form-item>
      ...
      <el-form-item class="new-item">
        <el-button type="primary" class="new-btn" @click="addLecture">新建讲次</el-button>
            ...
            <el-table class="line-table" :data="tableData" header-align="center">
                <el-table-column prop="className" label="讲次名称" align="center" ></el-table-column>
                <el-table-column prop="grade" label="科目"  align="center"></el-table-column>
                <el-table-column prop="term"  label="年级" align="center"> </el-table-column>
                <el-table-column prop="campus"  label="知识点" align="center"> </el-table-column>
                <el-table-column prop="curriculumTime"  label="层级" align="center"> </el-table-column>
