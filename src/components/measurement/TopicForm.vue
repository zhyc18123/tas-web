    ...
    <div class="widget am-cf">
      ...
      <div class="widget-body am-fr">
        <el-form :model="query" :rules="rules" ref="query" label-width="210px" class="demo-query">
          <el-form-item label="题目" prop="areaTeamId">
            <el-select v-model="query.areaTeamId" placeholder="题目">
              <el-option v-for="item in areaTeams" :key="item.areaTeamId" :label="item.areaTeamName" :value="item.areaTeamId"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="题型" prop="areaTeamId">
            <el-select v-model="query.areaTeamId" placeholder="题型">
              <el-option v-for="item in areaTeams" :key="item.areaTeamId" :label="item.areaTeamName" :value="item.areaTeamId"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="题干" prop="areaTeamId">
            <el-select v-model="query.areaTeamId" placeholder="题干">
              <el-option v-for="item in areaTeams" :key="item.areaTeamId" :label="item.areaTeamName" :value="item.areaTeamId"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="标准答案" prop="areaTeamId">
            <el-select v-model="query.areaTeamId" placeholder="标准答案">
              <el-option v-for="item in areaTeams" :key="item.areaTeamId" :label="item.areaTeamName" :value="item.areaTeamId"></el-option>
            </el-select>
          </el-form-item>
          <el-form-item label="分值" prop="areaTeamId">
            <el-select v-model="query.areaTeamId" placeholder="分值">
              <el-option v-for="item in areaTeams" :key="item.areaTeamId" :label="item.areaTeamName" :value="item.areaTeamId"></el-option>
            </el-select>
          </el-form-item>
